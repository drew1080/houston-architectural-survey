...
function optionsframework_options() {	
	...
	// Home Survey Type
	$home_survey_type = array("all" => "All surveys", "featured" => "Featured");	
	...
	$options[] = array( "name" => __('Recent Surveys Title','themetrust'),
						"desc" => __('Enter the title that will appear above the recent themes section on the home page.','themetrust'),
						"id" => "ttrust_recent_surveys_title",
						"std" => "Our Latest Work",
						"type" => "text");
							
	$options[] = array( "name" => __('Recent Surveys Description','themetrust'),
						"desc" => __('Enter the description that will appear above the recent surveys section on the home page.','themetrust'),
						"id" => "ttrust_recent_surveys_description",
						"std" => "Take a look at some of our recent surveys.",
						"type" => "textarea");
						
	
	$options[] = array( "name" => __('Number of Surveys to Show','themetrust'),
						"desc" => __('Enter the number of survey to show on the home page.','themetrust'),
						"id" => "ttrust_home_survey_count",
						"std" => "6",
						"type" => "text");
						
	$options[] = array( "name" => __('Type of Surveys to Show','themetrust'),
						"desc" => __('Select the type of surveys to show on the home page.','themetrust'),
						"id" => "ttrust_home_survey_type",
						"std" => "latest",
						"type" => "select",
						"options" => $home_survey_type);
